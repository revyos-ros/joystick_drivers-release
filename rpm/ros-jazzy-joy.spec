...
Requires:       ros-jazzy-sdl2-vendor
...
BuildRequires:  ros-jazzy-sdl2-vendor
...
%description
The joy package contains joy_node, a node that interfaces a generic joystick to
ROS 2. This node publishes a &quot;Joy&quot; message, which contains the current
